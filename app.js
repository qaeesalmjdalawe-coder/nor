...
function setupInstallButton() {
    ...
    // يظهر الزر في نسخة المتصفح، ويختفي داخل نسخة التطبيق المثبتة.
    ...
    btn.onclick = async () => {
        ...
        // هذا هو مربع التثبيت الرسمي في Chrome/Edge عندما يكون الموقع قابلاً للتثبيت.
        ...
        // إذا لم يرسل المتصفح الحدث، فهذا يعني أن شروط التثبيت لم تكتمل بعد
        // (غالباً الموقع مفتوح عبر HTTP أو من ملف محلي). لا ندّعي أن التثبيت تم.
...
function setupNotificationButton() {
    ...
    if (notifBtnTop) {
        // إذا كان الإذن ممنوحاً بالفعل → فعّل الزر
